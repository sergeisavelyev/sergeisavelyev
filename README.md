...
Data-аналитик. Автоматизация сбора данных, BI-отчёты, ETL-процессы.
...
[![audience-geo](https://github.com/sergeisavelyev/audience-geo-preview/main/assets/screen_osm.png)](https://github.com/sergeisavelyev/audience-geo-preview)

> Python · FastAPI · Playwright · H3 · OpenStreetMap 

Автоматический сбор демографических профилей по геозонам города через
Яндекс.Аудитории (браузерная автоматизация), обогащение данными OSM,
кластеризация и AI-анализ паттернов с интерактивными инсайтами.
